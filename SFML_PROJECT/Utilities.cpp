...
std::string Shitful::toString(sf::Keyboard::Key key)
{
...
float Shitful::toRadian(float degree)
{
	return 3.141592653589793238462643383f / 180.f * degree;
}
float Shitful::toDegree(float radian)
{
...
void Shitful::centerOrigin(sf::Text& text)
{
...
float Shitful::length(sf::Vector2f vector)
{
...
int Shitful::randomInt(int exclusiveMax)
{
