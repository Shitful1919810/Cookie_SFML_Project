...
#include "Utilities.h"
Shitful::TitleState::TitleState(StateStack& stack, Context context)
	: State(stack, context)
	, mText()
	, mShowText(true)
...
bool Shitful::TitleState::update(sf::Time dt)
{
	mTextEffectTime += dt;
...
bool Shitful::TitleState::handleEvent(const sf::Event& event)
{
